...
function Resume() {
  ...
  // useEffect(() => {
  //   axios
  //     .get("http://localhost:8000/api/front/educations")
  //     .then((res) => {
  ...
  // useEffect(() => {
  //   axios
  //     .get("http://localhost:8000/api/front/jobs")
  //     .then((res) => {
  //       setJob(res.data);
  //     })
  //     .catch((err) => {
  ...
  const education = [
    {
      ...
      institute: "Tejgaon University College (2019 - 2024)",
    ...
    {
      title: "Intermediate",
      institute: "Faridgonj Bangabandhu Govt. College (2017-2019)",
      desc: "The education should be very interactual. Ut tincidunt est ac dolor aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem in, lobortis mauris hendrerit ante.",
      rating: "4/5",
    },
    {
      title: "Secondary School Certificate",
      institute: "Protyashi R A High School (2012 - 2017)",
      desc: "The education should be very interactual. Ut tincidunt est ac dolor aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem in, lobortis mauris hendrerit ante.",
      rating: "4.95/5",
    },
  ];
  const jobs = [
    {
      title: "Fiverr Web Developer",
      institute: "Fiverr (2020 - 2022)",
      desc: "The education should be very interactual. Ut tincidunt est ac dolor aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem in, lobortis mauris hendrerit ante.",
      rating: "4/5",
    },
    {
      title: "Freelancer.com Web Developer",
      institute: "Freelancer.com (2020 - 2022)",
      desc: "The education should be very interactual. Ut tincidunt est ac dolor aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem in, lobortis mauris hendrerit ante.",
      rating: "4/5",
    },
    {
      title: "Upwork Web Developer",
      institute: "Upwork (2020 - 2022)",
      desc: "The education should be very interactual. Ut tincidunt est ac dolor aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem in, lobortis mauris hendrerit ante.",
      rating: "4.95/5",
    },
  ];
    ...
    <div id="resume">
      ...
      <div className="mt-5">
        <div className="pricing-subcon">
          <ul
            className="nav nav-tabs resume-button-con row"
            id="pills-tab"
            role="tablist"
          >
                ...
                <div className="col-lg-6">
                  ...
                  <div className="my-5">
                    <div className="prog-con">
                      ...
                      <div className="perc" style={{ right: 85 }}>
                        <span>85%</span>
                      </div>
                    </div>
                    <div className="prog-con">
                      ...
                      <div className="perc2" style={{ right: 100 }}>
                        <span>80%</span>
                      </div>
                    </div>
                    <div className="prog-con">
                      ...
                      <div className="perc3" style={{ right: 70 }}>
                        <span>90%</span>
                      </div>
                    </div>
                    <div className="prog-con">
                    ...
                    <div className="prog-con">
                      ...
                      <div className="perc5" style={{ right: 160 }}>
                        <span>70%</span>
                      </div>
                    </div>
                  </div>
